...
if __name__ == '__main__':
    ...
    print(s_init.findSubstring(s, words))
    print(s_pref.findSubstring(s, words))
    ...
    number = 10_000
    s, words = 'barfoofoobarthefoobarman', ['bar', 'foo', 'the']
    print(timeit.timeit(lambda: s_init.findSubstring(s, words), number=number))
    print(timeit.timeit(lambda: s_pref.findSubstring(s, words), number=number))
