...
if __name__ == '__main__':
    ...
    print(s_init.minSubArrayLen(target, nums))
    print(s_pref.minSubArrayLen(target, nums))
    ...
    print(timeit.timeit(lambda: s_init.minSubArrayLen(target, nums), number=number))
    print(timeit.timeit(lambda: s_pref.minSubArrayLen(target, nums), number=number))
