...
if __name__ == '__main__':
    ...
    s, p = "cbaebabacd", "abc"
    print(s_init.findAnagrams(s, p))
    print(s_pref.findAnagrams(s, p))
    ...
    number = 10_000
    s, p = "abab", "ab"
    print(timeit.timeit(lambda: s_init.findAnagrams(s, p), number=number))
    print(timeit.timeit(lambda: s_pref.findAnagrams(s, p), number=number))
