...
if __name__ == '__main__':
    ...
    print(s_pref.maxSubArray(numbers))
    print(s_alt.maxSubArray(numbers))
    ...
    print(timeit.timeit(lambda: s_pref.maxSubArray(numbers), number=1000))
    print(timeit.timeit(lambda: s_alt.maxSubArray(numbers), number=1000))
