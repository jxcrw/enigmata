...
if __name__ == '__main__':
    ...
    print(s_init.threeSumClosest(nums, target))
    print(s_pref.threeSumClosest(nums, target))
    ...
    number = 10_000
    nums,  target = [0, 0, 0],  1
    print(timeit.timeit(lambda: s_init.threeSumClosest(nums, target), number=number))
    print(timeit.timeit(lambda: s_pref.threeSumClosest(nums, target), number=number))
