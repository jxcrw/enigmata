...
if __name__ == '__main__':
    ...
    print(s_init.maxArea(heights))
    print(s_pref.maxArea(heights))
    ...
    number = 10_000
    heights = [1,8,6,2,5,4,8,3,7]
    print(timeit.timeit(lambda: s_init.maxArea(heights), number=number))
    print(timeit.timeit(lambda: s_pref.maxArea(heights), number=number))
