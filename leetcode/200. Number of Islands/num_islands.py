...
if __name__ == '__main__':
    ...
    grid2 = deepcopy(grid)
    grid3 = deepcopy(grid)
    print(s_init.numIslands(grid))
    print(s_alt.numIslands(grid2))
    print(s_alt.numIslands(grid3))
    ...
    grid2 = deepcopy(grid)
    grid3 = deepcopy(grid)
    print(timeit.timeit(lambda: s_init.numIslands(grid), number=number))
    print(timeit.timeit(lambda: s_alt.numIslands(grid2), number=number))
    print(timeit.timeit(lambda: s_alt.numIslands(grid3), number=number))
