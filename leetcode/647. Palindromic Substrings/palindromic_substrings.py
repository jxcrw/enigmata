...
if __name__ == '__main__':
    ...
    string = "abc"
    print(s_init.countSubstrings(string))
    print(s_pref.countSubstrings(string))
    ...
    print(timeit.timeit(lambda: s_init.countSubstrings(string), number=number))
    print(timeit.timeit(lambda: s_pref.countSubstrings(string), number=number))
